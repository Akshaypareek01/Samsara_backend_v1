...
const answersSchema = Joi.object({
  ...
  cycleRegularity: Joi.string()
    .valid(...answerOptions.cycleRegularity)
    .required(),
  periodDuration: Joi.string()
    .valid(...answerOptions.periodDuration)
    .required(),
  menstrualFlow: Joi.string()
    .valid(...answerOptions.menstrualFlow)
    .required(),
  bloodColor: Joi.string()
    .valid(...answerOptions.bloodColor)
    .required(),
  facialHair: Joi.string()
    .valid(...answerOptions.facialHair)
    .required(),
  weightGain: Joi.string()
    .valid(...answerOptions.weightGain)
    .required(),
  ...
  hormonalMedications: Joi.string()
    .valid(...answerOptions.hormonalMedications)
    .required(),
  periodPain: Joi.string()
    .valid(...answerOptions.periodPain)
    .required(),
  facialAcne: Joi.string()
    .valid(...answerOptions.facialAcne)
    .required(),
  lowLibido: Joi.string()
    .valid(...answerOptions.lowLibido)
    .required(),
  hairLoss: Joi.string()
    .valid(...answerOptions.hairLoss)
    .required(),
  darkSkinPatches: Joi.string()
    .valid(...answerOptions.darkSkinPatches)
    .required(),
  difficultyConceiving: Joi.string()
    .valid(...answerOptions.difficultyConceiving)
    .required(),
});
