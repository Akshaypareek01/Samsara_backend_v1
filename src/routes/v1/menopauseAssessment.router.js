...
router.post(
  '/calculate-risk',
  validate(menopauseAssessmentValidation.calculateRisk),
  menopauseAssessmentController.calculateRiskLevel
);
...
router.get(
  '/:assessmentId',
  validate(menopauseAssessmentValidation.getAssessment),
  menopauseAssessmentController.getAssessmentById
);
router.put(
  '/:assessmentId',
  validate(menopauseAssessmentValidation.updateAssessment),
  menopauseAssessmentController.updateAssessment
);
router.delete(
  '/:assessmentId',
  validate(menopauseAssessmentValidation.deleteAssessment),
  menopauseAssessmentController.deleteAssessment
);

// Reassessment route (smart route that creates or updates)
router.post(
  '/reassessment',
  validate(menopauseAssessmentValidation.submitReassessment),
  menopauseAssessmentController.submitReassessment
);
