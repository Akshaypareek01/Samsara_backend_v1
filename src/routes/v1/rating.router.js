...
router.route('/classes/:classId/ratings').get(validate(ratingValidation.getClassRatings), ratingController.getClassRatings);
...
router.route('/events/:eventId/ratings').get(validate(ratingValidation.getEventRatings), ratingController.getEventRatings);
...
router.route('/favorites').get(auth(), ratingController.getAllFavorites);

router.route('/favorites/classes').get(auth(), ratingController.getFavoriteClasses);

router.route('/favorites/events').get(auth(), ratingController.getFavoriteEvents);

router.route('/favorites/teachers').get(auth(), ratingController.getFavoriteTeachers);
