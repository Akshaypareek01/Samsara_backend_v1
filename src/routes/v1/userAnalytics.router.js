...
router
  ...
  .get(
    validate(userAnalyticsValidation.getUserUpcomingCustomSessions),
    userAnalyticsController.getUserUpcomingCustomSessions
  );
...
router
  ...
  .get(
    validate(userAnalyticsValidation.getUserBookedClassesByDateRange),
    userAnalyticsController.getUserBookedClassesByDateRange
  );

router
  .route('/:userId/booked/events')
  .get(
    validate(userAnalyticsValidation.getUserBookedEventsByDateRange),
    userAnalyticsController.getUserBookedEventsByDateRange
  );

router
  .route('/:userId/booked/sessions')
  .get(
    validate(userAnalyticsValidation.getUserCustomSessionsByDateRange),
    userAnalyticsController.getUserCustomSessionsByDateRange
  );
...
router
  ...
  .get(
    validate(userAnalyticsValidation.getUserAttendedClassesByDateRange),
    userAnalyticsController.getUserAttendedClassesByDateRange
  );
